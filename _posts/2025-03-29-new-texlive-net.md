...
The server has the latest Debian operating system and TeX Live 2025. It  has more memory and more cores available than the previous server.

As before, the virtual machine hosting the service has been kindly provided by Stefan Kottwitz, with support from [DANTE](https://www.dante.de).

To celebrate the update, Stefan has arranged a time limited 15% discount on three of his [LaTeX books](https://www.packtpub.com/en-us/search?q=stefan%20kottwitz&country=us&language=en):

<img alt="offer poster" width="100%" src="{{site.baseurl}}/img/learnlatex15.png"/>

Use the voucher code `LEARNLATEX15` (valid until 22nd April 2025).
