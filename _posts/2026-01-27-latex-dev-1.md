...
The first pre-release version for the 2026-06-01 LaTeX kernel went to CTAN few
...
`\usepackage{enumitem}` will simply be ignored when `\DocumentMetadata`is
...
repository](https://github.com/latex3/tagging-project/issues).
