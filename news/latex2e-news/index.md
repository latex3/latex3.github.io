...
|:-------------|--------------------------|-------------------------:|
| 2018/12/01 | <a href="{{site.baseurl}}/news/latex2e-news/ltnews29.pdf" target="_blank" onclick="vgwPixelCall('c200b8c6707a4774b6b97cd616a96ced');">LaTeX2e News Issue 29</a> | Bug fix replease with with changes to `base`, `tools`, and `amsmath`|
